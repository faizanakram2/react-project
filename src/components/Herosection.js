  ...
  return (
    <section data-aos="fade-up" className="relative text-center py-20 px-4 pt-40 pb-20">
      ...
      <div className="flex pt-10 justify-center items-center gap-4 mt-6">
        ...
        <img src={polygon} alt="ethereum" className="w-10 h-10 rounded-full" />
        <img src={trx} alt="ethereum" className="w-10 h-10" />
        <img src={matic} alt="ethereum" className="w-10 h-10" />
